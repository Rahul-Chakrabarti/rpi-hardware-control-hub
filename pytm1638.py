# TM1638 class
"""
This file defines complete functionality of the
TM1638 integrated circuit chip and display

This file is intended to work in the background for a device file,
such as calculator.py, and not intended to work on it's own.
